...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 bg-slate-900/40 backdrop-blur-md border-b border-slate-800/80 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-semibold text-lg text-slate-100 hidden md:block">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-slate-800">
          ...
          {/* Avatar frame */}
          <div className="w-10 h-10 rounded-full overflow-hidden bg-gradient-to-tr from-brand-500 to-indigo-600 flex items-center justify-center border border-slate-700/50 shadow-md">
            {user?.avatar ? (
              <img
                src={user.avatar}
                alt="Profile"
